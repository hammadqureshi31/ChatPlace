        ...
        <div className="flex flex-col items-center pt-14 px-4">
            <div className="w-full max-w-md">
                 ...
                 onSubmit={handleLogin}>
                    {(isSubmitting) => (
                        <Form className="bg-transparent rounded-lg p-6">
                            ...
                            <button type="submit" className="w-full px-2 py-2 text-lg text-white bg-[#5082FC] rounded-lg hover:bg-sky-500 focus:outline-none">
                ...
                <div className="mt-4 text-center flex flex-col gap-2 px-5">
                    ...
                    <span className="text-[#5082FC] cursor-pointer text-sm">Sign Up</span>
                </div>
            </div>
        </div>
    );
